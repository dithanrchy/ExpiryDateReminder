...
import com.example.expirydatereminder.data.Skincare


class SkincareAdapter(private val listData: ArrayList<Skincare>) : RecyclerView.Adapter<SkincareAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.btnDetail.setOnClickListener {
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_CATEGORY, "skincare")
