...
import com.example.expirydatereminder.data.Food

class FoodAdapter(private val listData: ArrayList<Food>) : RecyclerView.Adapter<FoodAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.btnDetail.setOnClickListener {
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_CATEGORY, "food")
